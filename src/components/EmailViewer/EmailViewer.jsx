...
const EmailViewer = ({email=null}) => {
    ...
    const {id, read, sender, time, subject, content, isFromMailingList=false} = email;
            ...
            <div>
                <div className="email-viewer__header">
                    <div>
                        <UtilityButton
                            label="Go back"
                            icon={<svg viewBox="0 0 16 16" className="icon-16p topnav-icon mr0-5" role="img" focusable="false" aria-hidden="true">
                                <g id="ic-arrow-left">
