...
const MailContentColumn = ({className}) => {
    ...
    const renderEmailViewer = () => {
        if(!currentlyOpenEmail){
            ...
            return (
                <div className="mail-content-column__welcome">
                    <div>
                        <div className="mail-content-column__welcome__text">
                            <span className="name">
                        ...
                        <div className="mail-content-column__welcome__icon">
    ...
    return (
        <section className={`mail-content-column ${className}`}>
            <div>
                {renderEmailViewer()}
            </div>
        </section>
