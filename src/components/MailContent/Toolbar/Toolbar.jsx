...
const Toolbar = ({className=''}) => {
    ...
    const {totalNumber: totalNumberOfEmails, selected: numberOfSelectedEmails, emails} = useSelector(state => state.mail.folders[currentOpenFolder]);
            ...
            return (
                <>
                    <UtilityButton
                        ...
                        id="mark-as-read-btn"
                        onClick={() => dispatch(toggleRead({emailids: getAllSelectedEmailIds()}))}
                        icon={
                    ...
                    <UtilityButton
                        ...
                        icon={
                            ...
                            <path fillRule="evenodd" d="M2 6a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1v7a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6Zm0-3h12v2H2V3Zm1 3v7a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V6H3Z"></path>
                            </g>
                            </svg>
                        }
                    />
                    ...
                    <UtilityButton
                        ...
                        id="move-to-btn"
                        icon={
                            <svg viewBox="0 0 16 16" className="icon-16p toolbar-icon" role="img" focusable="false" aria-hidden="true">
                            <g id="ic-folder-arrow-in">
                            <path fillRule="evenodd" d="M7.793 9H1V8h6.793L6.646 6.854a.5.5 0 1 1 .708-.708l1.858 1.859a.7.7 0 0 1 0 .99l-1.858 1.859a.5.5 0 0 1-.708-.708L7.793 9Z"></path>
                    ...
                    <UtilityButton
                        ...
                        icon={
                            <svg viewBox="0 0 16 16" className="icon-16p toolbar-icon" role="img" focusable="false" aria-hidden="true">
                            <g id="ic-tag">
                            <path fillRule="evenodd" d="m9.425 14.375 4.95-4.95L7.95 3.002H3v4.95l6.425 6.424Zm-.707.707a1 1 0 0 0 1.414 0l4.95-4.95a1 1 0 0 0 0-1.414L8.657 2.294A1 1 0 0 0 7.95 2H3a1 1 0 0 0-1 1v4.95a1 1 0 0 0 .293.707l6.425 6.425ZM5.5 6.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"></path>
                            </g>
                            </svg>
                        }
                    />
